...
ISR_HANDLER: 
	...
	*/
	...
	movi r9, 0x02				# r9 = button value comparator
	beq r9, r10, CURR_STATE_CTRL
	movi r9, 0x01
	beq r9, r10, PLAY_STATE_CTRL
...
CURR_STATE_CTRL:
	...
	movi r10, 0					# r10 = state comparator
	beq r13, r10, CSTATE0		# if curr_state = 0
	movi r10, 1
	beq r13, r10, CSTATE1		# if curr_state = 1
	movi r10, 2	
	beq r13, r10, CSTATE2		# if curr_state = 2
	movi r10, 3
	beq r13, r10, CSTATE3		# if curr_state = 3
...
PLAY_STATE_CTRL:
	movia r5, play_state		# ptr to play_state
	ldw r14, 0(r5)				# ld play_state value into r14
...
PSTATE0:
	movi r14, 1					# change play_state to 1
	stw r14, 0(r5)
	
	br ISREnd
	
PSTATE1:
	movi r14, 0					# change play_state to 0
	stw r14, 0(r5)
...
/*	r2 - addr of pushbutton
	...
	r9 - state comparator
	r10 - addr of play_state variable
	r11 - value of play_state variable
	r12 - play_state comparator
*/
...
LOOP:								# in case weird stuff happens
	br LOOP
